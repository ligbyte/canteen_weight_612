package com.stkj.cashier.home.ui.widget.charview;
...
import com.stkj.cashier.home.ui.widget.charview.bean.Item;
import com.stkj.cashier.home.ui.widget.charview.bean.ItemList;
...
public class ChartBarView extends View {
    ...
    private void drawTreeData (Canvas canvas, int current, int treeCount, ItemList data) {
        ...
        gradient = new LinearGradient(
                0, canvas.getHeight(),    // 起点：视图底部 (x0, y0)
                0, 0,    // 终点：视图顶部 (x1, y1)
                Color.parseColor("#ff70DDFF"),  // 底部颜色
                Color.parseColor("#ff3584FF"),  // 顶部颜色
