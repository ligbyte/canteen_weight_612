 ...
 * 公用弹窗fragment
 */
public class CommonRefundAlertDialogFragment extends BaseDialogFragment {
    ...
    protected int getLayoutResId() {
        return R.layout.dialog_common_alert_refund;
    }
        ...
        stvLeftBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mLeftNavClickListener != null) {
                    mLeftNavClickListener.onClick(CommonRefundAlertDialogFragment.this);
                }
            }
        });
        ...
        stvRightBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mRightNavClickListener != null) {
                    mRightNavClickListener.onClick(CommonRefundAlertDialogFragment.this);
                }
            }
        });
    }

    public CommonRefundAlertDialogFragment setNeedHandleDismiss(boolean needHandleDismiss) {
     ...
     * 设置左侧按钮文案
     */
    public CommonRefundAlertDialogFragment setLeftNavTxt(String leftNavTxt) {
     ...
     * 设置右侧按钮文案
     */
    public CommonRefundAlertDialogFragment setRightNavTxt(String rightNavTxt) {
     ...
     * 设置弹窗标题
     */
    public CommonRefundAlertDialogFragment setAlertTitleTxt(String alertTitle) {
     ...
     * 设置弹窗内容
     */
    public CommonRefundAlertDialogFragment setAlertContentTxt(String alertContent) {
     ...
     * 设置右侧按钮点击事件
     */
    public CommonRefundAlertDialogFragment setRightNavClickListener(OnSweetClickListener listener) {
     ...
     * 设置左侧按钮点击事件
     */
    public CommonRefundAlertDialogFragment setLeftNavClickListener(OnSweetClickListener listener) {
        mLeftNavClickListener = listener;
        return this;
    }

    public interface OnSweetClickListener {
        void onClick(CommonRefundAlertDialogFragment alertDialogFragment);
    }

    public static CommonRefundAlertDialogFragment build() {
        return new CommonRefundAlertDialogFragment();
    }
}
