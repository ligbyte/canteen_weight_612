...
public class CustomerInfo {
    ...
    private int balanceLoad;
    private String deviceInfo;
    private String dingUserId;
    private String accountType;
    private int type;
    private PriceYuan balance;
    ...
    public int getBalanceLoad() {
        return balanceLoad;
    }

    public void setBalanceLoad(int balanceLoad) {
    ...
    public PriceYuan getBalance() {
        return balance;
    }

    public void setBalance(PriceYuan balance) {
