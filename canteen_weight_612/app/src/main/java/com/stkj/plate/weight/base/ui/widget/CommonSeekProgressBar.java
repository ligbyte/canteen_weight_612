...
import com.stkj.plate.weight.base.callback.SimpleSeekBarChangeListener;
...
public class CommonSeekProgressBar extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray array = context.obtainStyledAttributes(attributeSet, com.stkj.plate.weight.R.styleable.CommonSeekProgressBar);
