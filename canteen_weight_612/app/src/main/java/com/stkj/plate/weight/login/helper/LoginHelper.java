package com.stkj.plate.weight.login.helper;
...
import com.stkj.plate.weight.login.ui.fragment.LoginAlertFragment;
...
//                                  AndroidUtils.restartApp();
    ...
    private void addMainLoginPlaceFragment(MainActivity activity, Fragment fragment) {
        FragmentUtils.safeAddFragment(activity.getSupportFragmentManager(), fragment, com.stkj.plate.weight.R.id.fl_login_placeholder);
    }
