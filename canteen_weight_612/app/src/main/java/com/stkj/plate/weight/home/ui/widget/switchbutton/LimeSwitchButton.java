 ...
 *
 */
public class LimeSwitchButton extends View{
    ...
    private LimeSwitchButton(Context context) {
        super(context);
    }
    public LimeSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setup(attrs);
    }
    public LimeSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(attrs);
    }
