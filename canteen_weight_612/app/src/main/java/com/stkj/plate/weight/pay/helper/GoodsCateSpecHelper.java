package com.stkj.plate.weight.pay.helper;
...
import com.stkj.plate.weight.pay.goods.callback.OnAddGoodsCateListener;
import com.stkj.plate.weight.pay.goods.callback.OnAddGoodsSpecListener;
import com.stkj.plate.weight.pay.goods.callback.OnDelGoodsCateListener;
import com.stkj.plate.weight.pay.goods.callback.OnDelGoodsSpecListener;
import com.stkj.plate.weight.pay.goods.callback.OnGetGoodsCateListListener;
import com.stkj.plate.weight.pay.goods.callback.OnGetGoodsSpecListListener;
import com.stkj.plate.weight.pay.goods.callback.OnGoodsCateSpecListener;
import com.stkj.plate.weight.pay.goods.data.GoodsConstants;
import com.stkj.plate.weight.pay.goods.model.AddGoodsCateParams;
import com.stkj.plate.weight.pay.goods.model.AddGoodsSpecParams;
import com.stkj.plate.weight.pay.goods.model.DelGoodsCateParams;
import com.stkj.plate.weight.pay.goods.model.DelGoodsSpecParams;
                    ...
                    public void subscribe(@io.reactivex.rxjava3.annotations.NonNull ObservableEmitter<Integer> emitter) throws Throwable {
                        try {
                            for (int goodsType : GoodsConstants.GOODS_TYPE_LIST) {
                                //获取商品分类
                                Response<BaseResponse<List<GoodsCate>>> goodsCateListSync = RetrofitManager.INSTANCE.getDefaultRetrofit().create(PayService.class).getGoodsCateListSync(goodsType).execute();
                                ...
                                if (goodsType == GoodsConstants.TYPE_GOODS_WEIGHT) {
                                    ...
                                    Response<BaseResponse<List<GoodsSpec>>> goodsSpecListSync = RetrofitManager.INSTANCE.getDefaultRetrofit().create(PayService.class).getGoodsSpecListSync(goodsType).execute();
