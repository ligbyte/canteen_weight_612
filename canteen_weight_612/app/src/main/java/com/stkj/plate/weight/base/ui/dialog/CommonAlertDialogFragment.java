...
public class CommonAlertDialogFragment extends BaseDialogFragment {
    ...
    protected int getLayoutResId() {
        return com.stkj.plate.weight.R.layout.dialog_common_alert;
    }
    ...
    private static volatile CommonAlertDialogFragment instance;

    public static CommonAlertDialogFragment build() {
        if (instance == null) {
            synchronized (CommonAlertDialogFragment.class) {
                if (instance == null) {
                    instance = new CommonAlertDialogFragment();
                }
            }
        }
        return instance;
